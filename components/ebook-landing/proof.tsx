...
import { EBOOK_PROOF } from "./content"

export function EbookProof() {
  ...
  return (
    <section id="prueba-real" className="relative scroll-mt-8 overflow-hidden">
      ...
      <DashedGrid gridId="ebook-proof" maxWidth="6xl" padding="px-4 py-16 md:px-6 md:py-24">
        <SectionHeading
          eyebrow={EBOOK_PROOF.badge}
          titleLead={EBOOK_PROOF.titleLead}
          titleAccent={EBOOK_PROOF.titleAccent}
          description={EBOOK_PROOF.description}
